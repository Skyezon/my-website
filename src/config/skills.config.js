...
const data = [
  ...
  },
  {
    ...
    'content' : `When it comes to project development, skills are needed so for the language or framework that i speak : Laravel / Lumen, SASS, Javascript, React, Java, C, PHP, Kotlin
    `,
    "type" : "primary",
    "icon" : desktop
